...
globalkeys = my_table.join(
	...
	awful.key({ ctrlkey, "Shift" }, "9", function()
		os.execute(string.format("amixer -q set %s 70%%", beautiful.volume.channel))
		beautiful.volume.update()
	end),
	awful.key({ ctrlkey, "Shift" }, "8", function()
		os.execute(string.format("amixer -q set %s 50%%", beautiful.volume.channel))
		beautiful.volume.update()
	end),
	awful.key({ ctrlkey, "Shift" }, "7", function()
		os.execute(string.format("amixer -q set %s 30%%", beautiful.volume.channel))
		beautiful.volume.update()
	end),
